            ...
            {isScrolled ? (
              ...
              >
                ...
                <div className="relative">
                  <div className="absolute -inset-x-2 -inset-y-1 bg-blue-900/40 blur-md rounded-lg"></div>
                  <div className="relative flex flex-col">
                    <span className="text-xl font-extrabold text-nfp-white tracking-wide drop-shadow-md">
                      NFP
                    </span>
                    <span className="text-sm text-nfp-white font-medium">
