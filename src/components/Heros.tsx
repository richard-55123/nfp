  ...
  return (
    <div className="px-[10%] py-6 flex flex-col justify-center relative h-[calc(100vh-133px)]">
      ...
      <div className="relative flex flex-col gap-5 w-full md:w-[70%] lg:w-[60%]">
        <h1 className="text-[1.8rem] sm:text-[2.2rem] md:text-[3.2rem] leading-[1.2] text-primary/90 font-extrabold">
          Nouvelle Force Politique – Ensemble, faisons bouger les choses !
        </h1>
        <span className="text-[1rem] sm:text-[1.1rem] md:text-[1.2rem] text-black/65 font-medium">
