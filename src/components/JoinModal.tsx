      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/80 z-50 flex items-end justify-end p-0 md:p-4"
            onClick={onClose}
          >
            {/* Modal avec animation de droite à gauche */}
            <motion.div
              initial={{ opacity: 0, x: '100%' }}
              animate={{ opacity: 1, x: 0 }}
              exit={{ opacity: 0, x: '100%' }}
              transition={{ type: "spring", damping: 20, stiffness: 300 }}
              className="bg-gradient-to-b from-nfp-blue to-nfp-dark-blue backdrop-blur-md rounded-none  shadow-2xl border-l-2 border-nfp-yellow/40 w-full md:w-3/4 lg:w-2/3 xl:w-1/2 h-screen md:h-auto md:max-h-screen overflow-y-auto"
            ...
            >
              ...
              <div className="bg-gradient-to-r from-nfp-yellow to-nfp-yellow/90 text-nfp-blue p-4 flex justify-between items-center sticky top-0 z-10">
                ...
                <button 
                  onClick={onClose}
                  className="text-nfp-blue hover:text-nfp-blue/70 transition-colors p-1 rounded-full hover:bg-nfp-blue/10"
                  aria-label="Fermer"
                >
              ...
              <div className="p-4 md:p-6 h-[calc(100vh-76px)] md:max-h-[80vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="bg-nfp-blue/40 p-4 rounded-xl border border-nfp-yellow/10">
                    <h4 className="text-nfp-yellow font-bold mb-4 flex items-center gap-2">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-nfp-yellow to-nfp-yellow/90 text-nfp-blue font-bold py-4 rounded-xl mt-6 flex items-center justify-center gap-2 text-lg shadow-lg hover:shadow-xl transition-all"
                  >
