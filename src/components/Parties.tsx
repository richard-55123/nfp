                ...
                <div className="mb-12 px-[10%]">
                    {/* <div className="flex items-center justify-between bg-gray-100 p-6 rounded-lg">
                        <div className="flex items-center">
                            <div className="bg-nfp-blue p-2 rounded-full mr-4">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-nfp-blue text-white px-5 py-2 rounded-md font-semibold flex items-center shadow-md hover:shadow-lg transition-shadow"
                        >
                            ...
                            >
                                <div className="flex items-start gap-6">
                                    <div className="flex-shrink-0">
                                        <div className="w-16 h-16 bg-gray-100 p-2 flex items-center justify-center rounded-md border border-gray-200">
                                            <img
                                                src={party.partyLogo}
                                                alt={`Logo ${party.name}`}
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <motion.button
                                                whileHover={{ scale: 1.05 }}
                                                whileTap={{ scale: 0.95 }}
                                                className="text-nfp-blue font-semibold flex items-center hover:text-nfp-yellow transition-colors"
                                            >
                                                En savoir plus
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 sticky top-6 shadow-sm">
                            <div className="mb-8">
                                ...
                                <motion.button
                                    ...
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="w-full border border-nfp-blue text-nfp-blue font-semibold py-3 px-4 rounded-md mb-6 hover:bg-nfp-blue hover:text-white transition-colors"
                                >
                            ...
                            <div className="bg-white border border-gray-200 p-6 rounded-lg mb-8 shadow-sm">
                                ...
                                <div className="flex justify-center mt-4">
                                    <div className="flex space-x-1">
                                        {[1, 2, 3].map((i) => (
                                            <div key={i} className="w-2 h-2 bg-nfp-yellow rounded-full"></div>
                                        ))}
                                    </div>
                                </div>
                            </div>
